...
namespace LeaRun.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'CreateDate'");
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'CreateUserId'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'CreateUserName'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'ModifyDate'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'ModifyUserId'");
            if (newdt.Rows.Count > 0)
            {
        ...
        {
            DataTable newdt = DataHelper.DataFilter(dt, "f_column = 'ModifyUserName'");
            if (newdt.Rows.Count > 0)
            {
