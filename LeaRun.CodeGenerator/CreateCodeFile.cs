...
namespace LeaRun.CodeGenerator
{
    ...
    public class CreateCodeFile
    {
        ...
        public static void CreateExecution(BaseConfigModel baseConfigModel, string strCode)
        {
            ...
            #region 实体类
            if (!strParam["entityCode"].IsEmpty())
            {
            ...
            #region 映射类
            if (!strParam["entitymapCode"].IsEmpty())
            {
            ...
            #region 服务类
            if (!strParam["serviceCode"].IsEmpty())
            {
            ...
            #region 接口类
            if (!strParam["iserviceCode"].IsEmpty())
            {
            ...
            if (!string.IsNullOrEmpty(businesCode))
            {
