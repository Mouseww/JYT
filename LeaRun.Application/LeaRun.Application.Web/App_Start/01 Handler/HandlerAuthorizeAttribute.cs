    ...
    public class HandlerAuthorizeAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (!this.FilterIP())
            {
                ...
                Content.Content = "<script type='text/javascript'>alert('很抱歉！您当前所在IP被系统拒绝访问！');top.learun.loading({ isShow: false});</script>";
            ...
            {
                ContentResult Content = new ContentResult();
                Content.Content = "<script type='text/javascript'>alert('很抱歉！系统不允许您在当前时段访问！');top.learun.loading({ isShow: false});</script>";
                filterContext.Result = Content;
                return;
            }
            //认证执行
            ...
            {
                ContentResult Content = new ContentResult();
                Content.Content = "<script type='text/javascript'>alert('很抱歉！您的权限不足，访问被拒绝！');top.learun.loading({ isShow: false});</script>";
                filterContext.Result = Content;
                return;
            }
        }
