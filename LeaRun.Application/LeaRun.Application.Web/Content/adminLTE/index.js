(function ($) {
    tablist = {
        newTab: function (item) {
            ...
            if (flag) {
                var str = '<a href="javascript:;" class="active menuTab" data-id="' + contentPath + dataUrl + '">' + menuName + ' <i class="fa fa-remove"></i></a>';
                $('.menuTab').removeClass('active');
                var str1 = '<iframe class="LRADMS_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + contentPath + dataUrl + '" frameborder="0" data-id="' + contentPath + dataUrl + '" seamless></iframe>';
        ...
        load: function () {
            ...
            $(".sidebar-toggle").click(function () {
                if (!$("body").hasClass("sidebar-collapse")) {
                    ...
                    $("#sidebar-menu").addClass('sidebar-menu2');
                } else {
                    $("body").removeClass("sidebar-collapse");
                    $("#sidebar-menu").removeClass('sidebar-menu2');
                }
            });
        },
                        ...
                        $.each(childNodes, function (i) {
                            ...
                            if (subchildNodes.length > 0) {
                                ...
                                $.each(subchildNodes, function (i) {
                                    ...
                                    _html += '<li><a class="menuItem" data-id="' + subchildNodesrow.F_ModuleId + '" href="' + contentPath + subchildNodesrow.F_UrlAddress + '"><i class="' + subchildNodesrow.F_Icon + '"></i>' + subchildNodesrow.F_FullName + '</a></li>';
                                });
                                _html += '</ul>';

                            } else {
                                _html += '<a class="menuItem" data-id="' + subrow.F_ModuleId + '" href="' + contentPath + subrow.F_UrlAddress + '"><i class="' + subrow.F_Icon + '"></i>' + subrow.F_FullName + '</a>';
                            }
                            _html += '</li>';
                        });
                        _html += '</ul>';
