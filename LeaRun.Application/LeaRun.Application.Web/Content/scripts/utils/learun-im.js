...
(function () {
    ...
    var IMRemove = function () {
        ...
        $obj.remove();
        $messagewrap.remove();
        top.learun.dialogTop({ msg: "消息服务器连接不上", type: "error" });
    };
    ...
    var  iMSignalR = function (options) {
        ...
        var imSignalR = {
            ...
            registerClient: function () {
                ...
                {
                    //更新联系人列表
                    imSignalR.chat.client.IMUpdateUserList = function (userAllList, onLineUserList) {
                    ...
                    //刷新最近的联系人
                    imSignalR.chat.client.IMUpdateLastUser = function (lastUserList) {
                        options.updateLastUser(lastUserList);
                    }
                    //刷新用户在线状态
                    imSignalR.chat.client.IMUpdateUserStatus = function (userId, isOnLine) {
