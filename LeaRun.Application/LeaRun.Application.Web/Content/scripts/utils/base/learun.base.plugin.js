...
(function ($, learun) {
    ...
    $.fn.uploadifyEx = function (opt) {
        ...
        if (opt.type == "uploadify") {
            ...
            $uploadifyEx.uploadify({
                ...
                height: opt.height,
                width: opt.width,
                fileTypeExts: opt.fileTypeExts,//'*.avi;*.mp3;*.mp4;*.bmp;*.ico;*.gif;*.jpeg;*.jpg;*.png;*.psd; *.rar;*.zip;*.swf;*.log;*.pdf;*.doc;*.docx;*.ppt;*.pptx;*.txt; *.xls; *.xlsx;',jsoncdb
    ...
    $.fn.userSelectBox = function () {
        ...
        $select.on('click', function () {//绑定点击事件jsonccx
