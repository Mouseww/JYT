        ...
        if (options.isprocessing)//如果是显示进程状态
        {
            ...
            $.each(options.nodeData, function (i, item) {
                ...
                if (item.F_NodeType == "startround") {
                    ...
                    _row += "<p>发起人：" + top.learun.data.get(["user", item.F_CreateUserId, "RealName"]); + "</p>";
                    ...
                    _row += "<p>处理人：" + top.learun.data.get(["user", item.F_ModifyUserId, "RealName"]); + "</p>";
                ...
                if (item.type != "startround" && item.type != "endround" && item.setInfo != undefined) {
                    ...
                    if (item.setInfo.nodeDesignateData != undefined) {
                        ...
                        for (var i in item.setInfo.nodeDesignateData.role) {
                            ...
                            _rowstr += ' <span class="label label-success">' + top.learun.data.get(["role", _postitem, "FullName"]) + '</span>';
                        ...
                        for (var i in item.setInfo.nodeDesignateData.post) {
                            ...
                            _rowstr += ' <span class="label label-info">' + top.learun.data.get(["post", _postitem, "FullName"]) + '</span>';
                        ...
                        for (var i in item.setInfo.nodeDesignateData.usergroup) {
                            ...
                            _rowstr += ' <span class="label label-warning">' + top.learun.data.get(["userGroup", _postitem, "FullName"]) + '</span>';
                        ...
                        for (var i in item.setInfo.nodeDesignateData.user) {
                            ...
                            _rowstr += ' <span class="label label-danger">' + top.learun.data.get(["user", _postitem, "FullName"]) + '</span>';
