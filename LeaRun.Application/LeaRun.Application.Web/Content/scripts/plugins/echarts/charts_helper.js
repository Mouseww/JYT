        ...
        success: function (data) {
            ...
            if (data) {
                switch (data.tempType) {
                    case 'pie':
                        DrawPie(data.picData, options.picDiv, data.title);
                        break;
                    case 'bar':
                        DrawBar(data.picData, options.picDiv, data.title);
                        break;
                    case 'line':
                        DrawLine(data.picData, options.picDiv, data.title);
                        break;
                    case 'map':
                        DrawPie(data.picData, options.picDiv, data.title);
                        break;
