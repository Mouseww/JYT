...
namespace LeaRun.Application.Web.Controllers
{
    ...
    public class PersonCenterController : MvcControllerBase
    {
        ...
        public ActionResult UploadFile()
        {
            ...
            userEntity.F_UserId = OperatorProvider.Provider.Current().UserId;
            userEntity.F_HeadIcon = virtualPath;
            userBLL.SaveForm(userEntity.F_UserId, userEntity);
            Operator user = OperatorProvider.Provider.Current();
            user.HeadIcon = virtualPath;
            OperatorProvider.Provider.UpdateCurrent(user);
            return Success("上传成功。");
        }
        /// <summary>
        /// 验证旧密码
