...
namespace LeaRun.Application.Busines.AuthorizeManage
{
    ...
    public class FilterTimeBLL
    {
        ...
        public void SaveForm(FilterTimeEntity filterTimeEntity)
        {
            ...
            {
                string keyValue = "";
                FilterTimeEntity entity = this.GetEntity(filterTimeEntity.F_ObjectId);
                if (entity != null)
                {
        ...
        public bool FilterTime()
        {
            ...
            if (filterTimeList.Count() > 0)
            {
                foreach (var item in filterTimeList)
                {
                    ...
                    {
                        case 1:
                            strFilterTime = item.F_WeekDay1;
                            break;
                        case 2:
                            strFilterTime = item.F_WeekDay2;
                            break;
                        case 3:
                            strFilterTime = item.F_WeekDay3;
                            break;
                        case 4:
                            strFilterTime = item.F_WeekDay4;
                            break;
                        case 5:
                            strFilterTime = item.F_WeekDay5;
                            break;
                        case 6:
                            strFilterTime = item.F_WeekDay6;
                            break;
                        case 7:
                            strFilterTime = item.F_WeekDay7;
                            break;
                        default:
                            break;
                    }
