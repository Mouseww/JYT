...
namespace LeaRun.Application.Busines.PublicInfoManage
{
    ...
    public class NewsBLL
    {
        ...
        public NewsEntity GetEntity(string keyValue)
        {
            ...
            newsEntity.F_NewsContent = WebHelper.HtmlDecode(newsEntity.F_NewsContent);
            return newsEntity;
        }
        #endregion
        ...
        /// </summary>
        /// <param name="keyValue">主键值</param>
        /// <param name="processId">进程实例值</param>
        /// <param name="newsEntity">新闻实体</param>
        /// <returns></returns>
        public void SaveForm(string keyValue, string processId, NewsEntity newsEntity)
        {
            try
            {
                newsEntity.F_NewsContent = WebHelper.HtmlEncode(newsEntity.F_NewsContent);
                service.SaveForm(keyValue, processId, newsEntity);
            }
            catch (Exception)
            {
                throw;
