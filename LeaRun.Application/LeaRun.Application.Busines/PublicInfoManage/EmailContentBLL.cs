...
namespace LeaRun.Application.Busines.PublicInfoManage
{
    ...
    public class EmailContentBLL
    {
        ...
        public EmailContentEntity GetEntity(string keyValue)
        {
            ...
            {
                emailContentEntity.F_AddresssHtml = WebHelper.HtmlDecode(emailContentEntity.F_AddresssHtml);
                emailContentEntity.F_CopysendHtml = WebHelper.HtmlDecode(emailContentEntity.F_CopysendHtml);
                emailContentEntity.F_BccsendHtml = WebHelper.HtmlDecode(emailContentEntity.F_BccsendHtml);
            }
        ...
        public void SaveForm(string keyValue, EmailContentEntity emailContentEntity, string addresssIds, string copysendIds, string bccsendIds)
        {
            try
            {
                ...
                emailContentEntity.F_AddresssHtml = WebHelper.HtmlEncode(emailContentEntity.F_AddresssHtml);
                emailContentEntity.F_CopysendHtml = WebHelper.HtmlEncode(emailContentEntity.F_CopysendHtml);
                emailContentEntity.F_BccsendHtml = WebHelper.HtmlEncode(emailContentEntity.F_BccsendHtml);
