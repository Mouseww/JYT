...
namespace LeaRun.Application.Entity.SystemManage
{
    ...
    public class DataBaseBackupEntity : BaseEntity
    {
        ...
        /// </summary>
        /// <returns></returns>
        [Column("F_DATABASEBACKUPID")]
        public string F_DatabaseBackupId { get; set; }
        /// <summary>
        /// 数据库连接主键
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        [Column("F_EXECUTEMODE")]
        public int? F_ExecuteMode { get; set; }
        /// <summary>
        /// 执行时间
        /// </summary>
        /// <returns></returns>
        [Column("F_EXECUTETIME")]
        public string F_ExecuteTime { get; set; }
        /// <summary>
        /// 备份路径
        /// </summary>
        /// <returns></returns>
        ...
        {
            this.F_DatabaseBackupId = Guid.NewGuid().ToString();
        ...
        {
            this.F_DatabaseBackupId = keyValue;
